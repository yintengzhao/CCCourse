...
-- -----------------------------------------------------
-- Table `CCCourse`.`admin`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CCCourse`.`admin` ;

CREATE TABLE IF NOT EXISTS `CCCourse`.`admin` (
...
CREATE TABLE IF NOT EXISTS `CCCourse`.`user` (
  ...
  `type` CHAR(8) NULL DEFAULT 'student',
  `time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
